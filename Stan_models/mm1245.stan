functions {
	real[] 	cbf(real t,
		...
		v10 = theta[35]*x[4]*x[6]/(theta[36]+x[4]);
		v11 = theta[39]*x[5]*x[8]/(theta[40]+x[5]);
		...
		dxdt[4] = theta[7]*v3 + theta[30]*v9 - theta[8]*v5 - theta[33]*x[4] - theta[38]*v10;
		dxdt[5] = theta[9]*v3 + theta[31]*v9 + theta[10]*v4 + theta[11]*v5 - theta[34]*x[5] - theta[41]*v11;
		dxdt[6] = v1 + v2 - v6 + v10;
		dxdt[7] = v3 + v9 - v7;
		dxdt[8] = v4 + v5 - v8 + v11;
