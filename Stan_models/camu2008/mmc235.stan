functions {
	real[] 	cbf(real t,
		...
		v10 = theta[34]*x[4]*x[7]/(theta[35]+x[4]);
		
		dxdt[1] = - theta[1]*v1 - theta[2]*v3;
		dxdt[2] = - theta[3]*v2 - theta[27]*v9;
		dxdt[3] = theta[4]*v1 + theta[5]*v2 + theta[28]*v3 + theta[29]*v9 - theta[6]*v4;
		dxdt[4] = theta[9]*v3 + theta[30]*v9 + theta[10]*v4 +theta[11]*v5 + theta[32]*v1 + theta[33]*v2 - theta[36]*v10;
		dxdt[5] = v1 + v2 - v6;
		dxdt[6] = v3 + v9 - v7;
		dxdt[7] = v4 + v5 - v8 + v10;
		dxdt[8] = theta[7]*v3 + theta[31]*v9 - theta[8]*v5;
