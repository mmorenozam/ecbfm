functions {
	real[] 	cbf(real t,
		...
		v10 = theta[34]*x[8]*x[5]/(theta[35]+x[8]);
		v11 = theta[38]*x[4]*x[7]/(theta[39]+x[4]);
		...
		dxdt[4] = theta[9]*v3 + theta[30]*v9 + theta[10]*v4 +theta[11]*v5 + theta[32]*v1 + theta[33]*v2 - theta[40]*v11;
		dxdt[5] = v1 + v2 - v6 + v10;
		dxdt[6] = v3 + v9 - v7;
		dxdt[7] = v4 + v5 - v8 + v11;
		dxdt[8] = theta[7]*v3 + theta[31]*v9 - theta[8]*v5 - theta[37]*v10;
