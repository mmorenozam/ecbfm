functions {
	real[] 	cbf(real t,
		...
		v9 = theta[25]*x[8]*x[5]/(theta[26]+x[8]);
		
		dxdt[1] = - theta[1]*v1 - theta[2]*v3;
		dxdt[2] = - theta[3]*v2;
		dxdt[3] = theta[4]*v1 + theta[5]*v2 - theta[6]*v4 + theta[28]*v9;
		dxdt[4] = theta[9]*v3 + theta[10]*v4 +theta[11]*v5;
		dxdt[5] = v1 + v2 - v6 + v9;
		dxdt[6] = v3 - v7;
		dxdt[7] = v4 + v5 - v8;
		dxdt[8] = theta[7]*v3 - theta[8]*v5 - theta[27]*v9;
