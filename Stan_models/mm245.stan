functions {
	real[] 	cbf(real t,
		...
		v10 = theta[32]*x[4]*x[6]/(theta[33]+x[4]);
		v11 = theta[36]*x[5]*x[8]/(theta[37]+x[5]);
		...
		dxdt[4] = theta[7]*v3 + theta[30]*v9 - theta[8]*v5 - theta[35]*v10;
		dxdt[5] = theta[9]*v3 + theta[31]*v9 + theta[10]*v4 + theta[11]*v5 - theta[38]*v11;
		dxdt[6] = v1 + v2 + v10 - v6;
		dxdt[7] = v3 + v9 - v7;
		dxdt[8] = v4 + v5 - v8 + v11;
