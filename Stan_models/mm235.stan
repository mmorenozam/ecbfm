functions {
	real[] 	cbf(real t,
		...
		dxdt[3] = theta[4]*v1 + theta[5]*v2 + theta[28]*v3 + theta[29]*v9 - theta[6]*v4 ;
		dxdt[4] = theta[7]*v3 + theta[30]*v9 - theta[8]*v5 ;
		dxdt[5] = theta[9]*v3 + theta[31]*v9 + theta[10]*v4 + theta[11]*v5 + theta[32]*v1 + theta[33]*v2 - theta[36]*v10;
		dxdt[6] = v1 + v2 - v6;
		dxdt[7] = v3 + v9 - v7;
		dxdt[8] = v4 + v5 - v8 + v10;
